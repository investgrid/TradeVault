...
ALTER TABLE "ai_insights" ADD CONSTRAINT "ai_insights_user_id_tv_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."tv_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "daily_checklist" ADD CONSTRAINT "daily_checklist_user_id_tv_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."tv_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "playbook_setups" ADD CONSTRAINT "playbook_setups_user_id_tv_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."tv_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "risk_rules" ADD CONSTRAINT "risk_rules_user_id_tv_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."tv_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "trades" ADD CONSTRAINT "trades_user_id_tv_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."tv_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "trades" ADD CONSTRAINT "trades_account_id_accounts_id_fk" FOREIGN KEY ("account_id") REFERENCES "public"."accounts"("id") ON DELETE set null ON UPDATE no action;